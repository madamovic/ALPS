...
data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parm8a'),['Staggered Susceptibility','Susceptibility','Staggered Magnetization'])
...
plt.legend(loc='best')
plt.savefig('2D_heisenberg_ladder_1.eps',dpi=400)
...
plt.legend(loc='best')
plt.savefig('2D_heisenberg_ladder_2.eps',dpi=400)
...
plt.legend(loc='best')
plt.savefig('2D_heisenberg_ladder_3.eps',dpi=400)