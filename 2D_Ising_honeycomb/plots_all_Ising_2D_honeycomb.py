...
plt.legend(loc='best')
plt.savefig("figure1_honeycomb.eps",dpi=300)
...
plt.title(u'2D Izingov model na honeycomb rešetki')
plt.legend(loc='best')
plt.savefig("figure2_honeycomb.eps",dpi=300)
...
plt.title(u'2D Izingov model  na honeycomb rešetki')
plt.legend(loc='best')
plt.savefig("figure3_honeycomb.eps",dpi=300)
...
plt.title(u'2D Izingov model na honeycomb rešetki')
plt.legend(loc='best')
plt.savefig("figure4_honeycomb.eps",dpi=300)
...
plt.title(u'2D Izingov model na honeycomb rešetki')
plt.legend(loc='best')
plt.savefig("figure5_honeycomb.eps",dpi=300)



f = open('binderdata_2D_Ising_honeycomb.txt','w')
...
fg = open('binderdata_rounded_t_2D_Ising_honeycomb.txt','w')
...
fh=open('binderdata_rounded_t_2D_Ising_honeycomb.txt','w')
...
s=open('binderdata_rounded_t_redosled_2D_Ising_honeycomb.txt','w')
