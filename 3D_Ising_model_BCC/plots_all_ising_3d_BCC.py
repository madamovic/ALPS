...
plt.legend(loc='best')
plt.savefig("figure47.eps",dpi=300)
...
plt.title('3D Izingov model, BCC')
plt.legend(loc='best')
plt.savefig("figure48.eps",dpi=300)
...
plt.title('3D Izingov model, BCC')
plt.legend(loc='best')
plt.savefig("figure49.eps",dpi=300)
...
plt.title('3D Izingov model, BCC')
plt.legend(loc='best')
plt.savefig("figure50.eps",dpi=300)
...
plt.title('3D Izingov model, BCC')
plt.legend(loc='best')
plt.savefig("figure51.eps",dpi=300)
