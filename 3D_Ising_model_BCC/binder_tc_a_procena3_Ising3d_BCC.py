...
pyalps.evaluateSpinMC(pyalps.getResultFiles(prefix='parm7g'))

#load the susceptibility and collect it as function of temperature T
data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parm7g'),'Binder Cumulant')
