...
input_file = pyalps.writeInputFiles('parm7n',parms)
pyalps.runApplication('spinmc',input_file,Tmin=5)
# use the following instead if you have MPI
#pyalps.runApplication('spinmc',input_file,Tmin=5,MPI=4)

pyalps.evaluateSpinMC(pyalps.getResultFiles(prefix='parm7n'))

data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parm7n'),'Connected Susceptibility')
...
two_minus_eta=2.5 #your estimate
for d in connected_susc:
    l = d.props['L']
