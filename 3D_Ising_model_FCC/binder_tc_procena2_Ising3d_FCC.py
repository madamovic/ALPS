...
data = pyalps.loadMeasurements(pyalps.getResultFiles(prefix='parm7c'),'Binder Cumulant')
...
plt.xlabel('$t=(T-T_c)/T_c, T_c=10.79$')
plt.ylabel('Binderov kumulant U4 $g$')
plt.title('3D Izingov model, FCC')
plt.legend(loc='best')
plt.savefig('figure76.eps',dpi=300)
